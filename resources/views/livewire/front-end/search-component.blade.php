    ...
    <div class="container">
        ...
        <div class="wrap-breadcrumb">
            <ul>
                ...
                <li class="item-link"><span>Search Products</span></li>
            </ul>
        </div>
        <div class="row">
            ...
            <div class="col-lg-9 col-md-8 col-sm-8 col-xs-12 main-content-area">
                <div class="wrap-shop-control">
                    <!--Category Name Show-->
                    <h1 class="shop-title">{{config('app.name')}}</h1>
            ...
            <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12 sitebar">
                <div class="widget mercado-widget categories-widget">
                    <h2 class="widget-title">All Sub Categories</h2>
                    <div class="widget-content">
                        <ul class="list-category">
                            @foreach($subCategories as $subCategory)
                            <li class="category-item {{count($subCategory->childCategories) > 0 ? 'has-child-cate' : ''}}">
                                <a href="{{route('product.category',['category_slug'=>$subCategory->category->slug,'scategory_slug'=>$subCategory->slug])}}" class="cate-link">{{$subCategory->name}}</a>
                                @if(count($subCategory->childCategories) > 0)
                                <span class="toggle-control">+</span>
                                <ul class="sub-cate">
                                    @foreach($subCategory->childCategories as $childCategory)
                                    <li class="category-item">
                                        <a href="{{route('product.category',['category_slug'=>$subCategory->category->slug,'scategory_slug'=>$subCategory->slug,'ccategory_slug'=>$childCategory->slug])}}" class="cat-link"><i class="fa fa-caret-right"></i>{{$childCategory->name}}</a>
                                    </li>
                                    @endforeach
                                </ul>
                                @endif
