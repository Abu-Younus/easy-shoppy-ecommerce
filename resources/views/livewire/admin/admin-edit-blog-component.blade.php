                    ...
                    <div class="panel-body">
                        ...
                        <div class="col-md-8">
                            <div class="panel panel-default">
                                ...
                                <div class="panel-body">
                                    <!--Update Blog Form-->
                                    <form class="form-horizontal" wire:submit.prevent="updateBlog" onsubmit="$('#processing').show();">
                                            ...
                                            <div class="col-md-4">
                                                <div class="choose-payment-methods">
                                                    <label class="payment-method">
                                                        <input name="published_date" id="payment-method-bank" value="schedule" @if($blog->schedule==true) checked @else @endif type="radio" wire:model="published_date">
                                                        <span>Schedule</span>
                                                    </label>
                                                    <label class="payment-method">
                                                        <input name="published_date" id="payment-method-visa" value="current" @if($blog->current==true) checked  @else @endif type="radio" wire:model="published_date">
                                                        <span>Current</span>
                                                    </label>
                                                </div>
                                        ...
                                        <!--Published Date Schedule or Current Check-->
                                        @if($published_date == 'schedule')
                                            <div class="form-group">
                                                <label class="col-md-4 control-label">Schedule DateTime <span class="text-danger">*</span></label>
                                                <div class="col-md-4">
                                                    <input type="datetime-local" class="form-control input-md" value="{{ $blog->schedule ? $blog->published_date : '' }}" wire:model="schedule_datetime" />
