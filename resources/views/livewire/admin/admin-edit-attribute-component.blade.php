                            ...
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <div class="row">
                                        ...
                                        <!--All Attributes and All Products Link Button-->
                                        <div class="col-md-6">
                                ...
                                <div class="panel-body">
                                    ...
                                    <form class="form-horizontal" wire:submit.prevent="updateAttribute" onsubmit="$('#processing').show();">
