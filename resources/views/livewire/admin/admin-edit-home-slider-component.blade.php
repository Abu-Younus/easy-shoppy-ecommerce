                    ...
                    <div class="panel-body">
                        ...
                        <div class="col-md-8">
                            <div class="panel panel-default">
                                ...
                                <div class="panel-body">
                                    <!--Update Slide Form-->
                                    <form class="form-horizontal" enctype="multipart/form-data" wire:submit.prevent="updateSlide" onsubmit="$('#processing').show();">
