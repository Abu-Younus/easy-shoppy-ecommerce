                            ...
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <div class="row">
                                        ...
                                        <!--All Coupons and All Campaigns Link Button-->
                                        <div class="col-md-8">
                                ...
                                <div class="panel-body">
                                    <!--Coupon Store Form-->
                                    <form class="form-horizontal" wire:submit.prevent="storeCoupon" onsubmit="$('#processing').show();">
...
@push('scripts')
    <script>
        //function of coupon expiry date
       $(function() {
