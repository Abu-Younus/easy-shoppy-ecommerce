@section('page-title')
    Product Specification Add | Admin |
@endsection
                            ...
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <div class="row">
                                        ...
                                        <!--All Spcifications and All Products Link Button-->
                                        <div class="col-md-6">
                                ...
                                <div class="panel-body">
                                    <!--Specification Store Form-->
                                    <form class="form-horizontal" wire:submit.prevent="storeSpecification" onsubmit="$('#processing').show();">
