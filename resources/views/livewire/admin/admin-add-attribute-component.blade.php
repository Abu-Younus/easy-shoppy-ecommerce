                            ...
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <div class="row">
                                        ...
                                        <!--All Attributes and All Products Button-->
                                        <div class="col-md-6">
                                            <a href="{{route('admin.attributes')}}" class="btn btn-success btn-sm pull-right" style="margin-left: 4px;">All Attributes</a>
                                            <a href="{{route('admin.products')}}" class="btn btn-info btn-sm pull-right" style="margin-right: 4px;">All Products</a>
                                        </div>
                                    </div>
                                </div>
                                <div class="panel-body">
                                    <!--Attribute Store Form-->
                                    <form class="form-horizontal" wire:submit.prevent="storeAttribute" onsubmit="$('#processing').show();">
                                        <div class="form-group">
                                            <label class="col-md-4 control-label">Attribute Name <span class="text-danger">*</span></label>
                                            <div class="col-md-4">
