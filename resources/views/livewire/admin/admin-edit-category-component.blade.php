                        ...
                        <div class="col-md-8">
                            <div class="panel panel-default">
                                ...
                                <div class="panel-body">
                                    ...
                                    <form class="form-horizontal" wire:submit.prevent="updateCategory" onsubmit="$('#processing').show();">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                @if($newicon)
                                                    <img src="{{$newicon->temporaryUrl()}}" width="80"/>
                                                @else
                                                    @if($icon)
                                                        <img src="{{asset('assets/images/category')}}/{{$icon}}" width="80" />
                                                    @endif
                                                @endif
