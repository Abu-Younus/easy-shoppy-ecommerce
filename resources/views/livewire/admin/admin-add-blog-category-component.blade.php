                        ...
                        <div class="col-md-8">
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <div class="row">
                                        <div class="col-md-6">
                                            <h5>Add New Blog Category</h5>
                                        </div>
                                        <!--All Blog Categories Button-->
                                        <div class="col-md-6">
                                ...
                                <div class="panel-body">
                                    <!--Store Blog Category Form-->
                                    <form class="form-horizontal" wire:submit.prevent="storeBlogCategory" onsubmit="$('#processing').show();">
