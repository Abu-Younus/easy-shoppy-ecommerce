...
class UserDashboardWishlistComponent extends Component
{
    ...
    {
        //view customer dashboard wishlist component
        return view('livewire.user.user-dashboard-wishlist-component')->layout('layouts.master');
    }
}
